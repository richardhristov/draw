...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/file-saver/dist/FileSaver.min.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./v1.js":"../node_modules/uuid/dist/esm-browser/v1.js","./v3.js":"../node_modules/uuid/dist/esm-browser/v3.js","./v4.js":"../node_modules/uuid/dist/esm-browser/v4.js","./v5.js":"../node_modules/uuid/dist/esm-browser/v5.js"}],"js/draw.js":[function(require,module,exports) {
"use strict";
...
function updateCanvas(canvas, shapes) {
  shapes.forEach(function (el) {
    return drawShape(canvas, el);
  });
}
...
},{}],"js/shapes.js":[function(require,module,exports) {
"use strict";
...
var toolEllipse = {
  ...
  MouseMove: function MouseMove(xy, startXy) {
    ...
    var radiusY = Math.abs(xy[1] - startXy[1]);
    var centerX = radiusX / 2 + Math.min(xy[0], startXy[0]);
    var centerY = radiusY / 2 + Math.min(xy[1], startXy[1]);
    shapesForeground = [];
    shapesForeground.push(_objectSpread({}, SHAPES.SHAPE_ELLIPSE, {
      strokeColor: options.strokeColor,
      strokeWidth: options.strokeWidth,
      fillColor: options.fillColor,
      alpha: options.alpha,
...
var toolSelect = {
  ...
  MouseUp: function MouseUp(xy, startXy) {
    ...
    shapesSelected.forEach(function (s) {
      ...
      shapes.filter(function (ss) {
        return ss && ss.groupId == s.groupId && shapesSelected.indexOf(ss) === -1;
      }).forEach(function (ss) {
        return shapesSelected.push(ss);
      });
    });
    refreshSelection();
...
function refreshCanvas() {
  (0, _draw.clearCanvas)($canvas[0]);
  (0, _draw.updateCanvas)($canvas[0], shapes);
  (0, _draw.updateCanvas)($canvas[0], shapesForeground);
} // Tool event listener


(0, _jquery.default)(document).on('click', '.js-btn-tool', function () {
  var $el = (0, _jquery.default)(this);
  var t = $el.data('tool');
  var tt = tools.find(function (ttt) {
    return ttt.type === t;
  });
...
(0, _jquery.default)(document).on('click', '.js-btn-group', function () {
...
(0, _jquery.default)(document).on('click', '.js-btn-ungroup', function () {
  shapesSelected.filter(function (s) {
    return s && s.groupId;
  }).forEach(function (s) {
    shapes.filter(function (ss) {
      return ss && ss.groupId === s.groupId;
    }).forEach(function (ss) {
      return ss.groupId = null;
    });
  });
...
(0, _jquery.default)(document).on('click', '.js-btn-save', function (e) {
  ...
  var data = new Blob([JSON.stringify(shapes)], {
    type: 'text/plain;charset=utf-8'
  });
  var filename = 'draw.json';
  (0, _fileSaver.saveAs)(data, filename);
}); // Load button event listeners

(0, _jquery.default)(document).on('click', '.js-btn-load', function (e) {
  if (!window.File || !window.FileReader || !window.FileList || !window.Blob) {
    alert('Error, your browser does not support loading and saving!');
    e.preventDefault();
    return;
  ...
  (0, _jquery.default)('#js-input-load').val('').click();
});
(0, _jquery.default)(document).on('input', '#js-input-load', function (e) {
  if (!window.File || !window.FileReader || !window.FileList || !window.Blob) {
    alert('Error, your browser does not support loading and saving!');
    e.preventDefault();
    return;
...
(0, _jquery.default)(document).ready(function () {
  $canvas = (0, _jquery.default)('#js-canvas');
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","file-saver":"../node_modules/file-saver/dist/FileSaver.min.js","uuid":"../node_modules/uuid/dist/esm-browser/index.js","./draw":"js/draw.js","./shapes":"js/shapes.js"}],"bundle.js":[function(require,module,exports) {
"use strict";
...
},{"./scss/site.scss":"scss/site.scss","jquery":"../node_modules/jquery/dist/jquery.js","./js/site":"js/site.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
